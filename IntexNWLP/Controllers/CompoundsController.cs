...
namespace IntexNWLP.Controllers
{
    public class CompoundsController : Controller
    {
        ...
        public ActionResult Details(int? id)
        {
            ...
            Compound compound = db.Compound.Find(id);
            if (compound == null)
            {
                return HttpNotFound();
            }
        ...
        public ActionResult Create([Bind(Include = "LTNumber,compoundName,compoundDescription")] Compound compound)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "LTNumber,compoundName,compoundDescription")] Compound compound)
        {
            if (ModelState.IsValid)
            {
